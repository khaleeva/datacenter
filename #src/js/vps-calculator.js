...
function changeRangeValueFromLabelInput() {
    ...
    label_inputs[0].type = "text";
    label_inputs[0].focus();
    label_inputs[0].setSelectionRange(label_inputs[0].value.length, label_inputs[0].value.length)

    label_inputs[0].type = "number";
